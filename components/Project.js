...
export default function Project(props) {
  ...
  return (
    ...
    <section className='bg-gray-100 max-w-[42rem]  border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative  hover:bg-gray-200 transition group-even:pl-8'>
        <div className='pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] sm:h-[28rem] flex flex-col h-full group-even:ml-[18rem]'>
