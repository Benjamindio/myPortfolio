...
import morningNewsImg from "@/public/morningnews.png"
import weatherappImg from "@/public/weatherapp.png"
import pokedexImg from "@/public/pokedex.png"
import talkingPDFImg from "@/public/talkingPDF.png"
...
export const experiencesData = [
  ...
  {
    title: "Projet entrepreneurial de création de site e-commerce",
...
export const projectsData = [
  {
    title: "TalkingPDF",
    description:
      "TalkingPDF est une application web permettant de chatter avec une IA qui vous lira le contenu d'un PDF.",
    tags: ["React","TailwindCSS", "MongoDB","Redux","NoSQL", "OpenAI","NodeJS", "Express","Pinecone", "Vercel", "Cloudinary"],
    GithubFrontend:'https://github.com/Benjamindio/smartPdf',
    GithubBackend:'https://github.com/Benjamindio/mypdf-backend',
    live:"https://smart-pdf-benjamindio.vercel.app/",
    imageUrl: medmeImg,
  },
  {
    title: "Medme",
    ...
    live:"https://youtu.be/iVAHcigtdB0",
    imageUrl: talkingPDFImg,
  },
  {
    title: "Morning News",
    description:
      "MorningNews est une application qui va vous permettre d’afficher les news récentes du journal The Verge. Vous pourrez également sauvegarder vos articles préférés et les retrouver en vous connectant à votre compte.",
    tags: ["React", "Next.js","Webservices","Express", "NodeJs", "Redux",],
    GithubFrontend:'https://github.com/Benjamindio/morningNews-frontend',
    GithubBackend:'https://github.com/Benjamindio/morningNews-backend',
    live:"https://morning-news-frontend-benjamindio.vercel.app/",
    imageUrl: morningNewsImg,
  },
  {
    title: "MyMoviz",
    description:
